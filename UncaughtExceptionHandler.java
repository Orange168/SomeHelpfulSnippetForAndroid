...
package com.anl.phone.wxb.utils.exception;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
	...
	public void collectDeviceInfo(Context ctx) {
		try {
			...
			Log.e(TAG, "collectDeviceInfo() an error occurred when collect package info NameNotFoundException:", e);
		}
		...
		for (Field field : fields) {
			try {
				...
				Log.e(TAG, "collectDeviceInfo() an error occurred when collect crash info Exception:", e);
			}
		}
	}
	...
	private String saveCatchInfo2File(Throwable ex) {
		...
		try {
			...
			if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
				String path = Environment.getExternalStorageState() + "/crash/";
